...
Define the artifact before deciding how personal, explanatory, persuasive, or
compressed the copy should be.

| Artifact | Usual relationship to reader | Common risk |
| --- | --- | --- |
...
| Policy or boundary note | Plain arrangement, exception, consequence, and alternative when relevant. | Defensive legalism or reassurance that obscures the boundary. |

Treat this table as a starting point, not a template. State the actual
...
- What is the central editorial move: the selection, emphasis, sequence, or
...
- What is the most likely weak human execution: transcription, laundry list,
  abstraction, shapeless explanation, hard sell, strained originality, or
  excessive qualification?
- Where could the writing become flat, clumsy, repetitive, over-written,
  under-written, tonally wrong, or too pleased with its own phrasing?
- Which source category is most likely to become a paragraph merely because it
  was supplied?
- What tempting opening, rhetorical device, or conclusion would weaken the
  emphasis or the speaker's credibility?

### MODEL-DEFAULT RISK

- What would a fluent model predictably add or regularise here?
