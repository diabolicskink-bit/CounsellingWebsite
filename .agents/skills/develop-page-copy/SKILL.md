...
description: >
  Plan complete visitor-facing pages or create durable page-copy handoff
  artifacts using the repository copywriter. Use when the user explicitly asks
  for whole-page direction, several connected sections developed as one page,
  a saved docs/page-plan artifact, or a semantic copy handoff for later design.
  Do not use for ordinary single-section drafting, line editing, copy review,
  visual design, implementation, or insertion of approved wording.
---
...
When the user asks for several connected sections or a complete page, use the
copywriter workflow for the requested scope. Check that sections develop the
...
Create a file under `docs/page-plan/` only when the user requests a saved
artifact or later design or implementation clearly requires one. Include only:

- page and status;
- selected direction or recommended copy;
...
Put the page direction or clean copy first. Keep rationale proportionate. Page
copy work does not authorise visual design, implementation, research creation,
or unrelated documentation changes unless the user asks for them.
