...
- For public copy, content hierarchy, inclusion language, enquiry flow, metadata wording, or visitor-facing positioning, read [docs/project/writing-direction.md](docs/project/writing-direction.md), the relevant content and research, and current facts in source or [docs/project/current-scope.md](docs/project/current-scope.md). Consult [docs/project/product-direction.md](docs/project/product-direction.md) only when the task needs one of its stable practice facts.
