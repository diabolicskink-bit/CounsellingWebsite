...
- Do not perform ad hoc interactive or visual browser verification of private analytics unless the owner explicitly requests it. Existing focused automated coverage may still run when proportionate, but the owner alone assesses the rendered analytics interface.
