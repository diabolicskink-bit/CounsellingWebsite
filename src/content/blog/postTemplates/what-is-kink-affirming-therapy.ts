...
There are limits to what can be concluded from studies like these. They do not show that BDSM improves psychological wellbeing, nor would it make sense to conclude that people involved in BDSM are somehow healthier as a group. Much of the research is cross-sectional, community samples are often self-selecting, and definitions of BDSM are not consistent across studies.

A systematic review by De Neef and colleagues (2019) noted many of these limitations. Research into BDSM has grown considerably, but there is still much that is not known about how kink develops, how it changes over time, and what role it plays psychologically for different people.

The evidence is considerably stronger on a narrower point: there is little justification for treating consensual kink itself as evidence of psychopathology.
...
The relationship between kink and trauma tends to attract overly simple explanations.

There is no good evidence that BDSM interests, as a group, can be explained as the result of trauma. The Australian population study found no greater history of sexual coercion among BDSM participants than among non-participants (Richters et al., 2008), while reviews of the broader literature have found insufficient evidence for trauma as a general explanation of BDSM interests (De Neef et al., 2019). Current clinical guidelines specifically caution therapists against assuming that kink is necessarily a trauma response (Sprott et al., 2023).

That finding should not be turned into the equally rigid claim that personal history has nothing to do with sexuality.

Sexuality develops as part of a person's wider psychological life. Attachment, relationships, learning, shame, fantasy, emotional regulation and formative experiences can all become woven into what someone eventually finds erotic. Trauma may be relevant for a particular person without being a general explanation for kink.
...
People can engage in apparently similar practices for very different reasons.
...
Any discussion of kink-affirming practice also has to take seriously the possibility of harm within kink relationships.

Consent occupies an unusually explicit place in BDSM culture. Negotiation, limits, safewords, aftercare and discussions of risk form part of how many people within kink communities think about ethical practice. Dunkley and Brotto (2020), in their review of consent within BDSM, describe mutual informed consent as one of the central features separating consensual BDSM from abuse.

None of this makes kink communities immune to coercion or abuse.

People can be pressured into activities they do not really want. Safewords can be ignored. Boundaries can be crossed. Someone may continue agreeing to things because they are frightened of losing a relationship, because they have become emotionally dependent on a partner, or because an initially negotiated power dynamic has gradually become difficult to challenge.

Assessing these situations requires some understanding of kink because many of the usual visual markers of an abusive relationship are unreliable in BDSM.

Pain, restraint, humiliation, obedience or ownership language cannot, by themselves, tell us whether somebody is being abused. A consensual relationship may deliberately contain all of them. At the same time, the language of BDSM does not turn coercion into consent simply because somebody calls themselves a Dominant or describes the relationship as power exchange.
...
A relationship can appear extremely unequal from the outside while containing a great deal of deliberate choice and negotiation. A conventional-looking relationship can contain very little of either.

A therapist unfamiliar with kink can misread the first situation. A therapist too invested in appearing kink-positive can miss the second.

## Being kink-friendly and being kink-aware are not quite the same thing
...
There is a useful clinical difference between being distressed *by* a sexual interest and being distressed by the shame, secrecy or anticipated rejection surrounding it. Those experiences can coexist, but they are not interchangeable and they do not necessarily need the same kind of therapy.

## Sometimes kink is simply part of the background

Competence with kink also involves knowing when it has little to do with the reason somebody is seeking counselling.

A person can be in a 24/7 D/s relationship and be grieving. A Dominant can become depressed. A submissive can struggle with social anxiety. Someone who attends BDSM events can have difficulties with work, family or relationships that would look familiar in almost any therapy room.
...
The clinical guidelines developed by Sprott and colleagues (2023) specifically caution against assuming that a presenting problem has been caused by kink.

At other times, kink may turn out to be highly relevant. It can bring themes of control, dependency, responsibility, shame, trust and vulnerability into unusually sharp focus.
...
From an attachment-informed or psychodynamic perspective, these can be useful areas of exploration because the same emotional themes often appear in different parts of a person's life.

They should emerge from the work rather than being imposed upon it. Sometimes a fetish or kink has a rich personal history and considerable psychological meaning. Sometimes it is simply something somebody finds very arousing. Therapy does not need to manufacture complexity where the person themselves experiences none.

## What might kink-affirming therapy look like?

Kink-affirming therapy is not a separate school of psychotherapy. A therapist might work psychodynamically, relationally, with attachment theory, CBT, schema therapy or from another therapeutic orientation.

The difference is largely in the knowledge and assumptions brought to the work.

A therapist should be able to hear somebody describe enjoying submission without assuming that they are powerless, and hear somebody describe dominance without treating the desire for control as inherently pathological. They should be comfortable exploring trauma where it is relevant without treating trauma as the default explanation for kink.

They should also know enough about BDSM that ordinary references to a scene, a collar, aftercare, a play partner or a D/s relationship do not derail the conversation into a basic lesson about kink.

For the client, much of this may feel quite ordinary. Kink can enter the conversation when it is relevant and remain in the background when it is not. An experience can be explored because it was emotionally important rather than because it was sexually unconventional.
...
The more defensible conclusion is also the more clinically useful one. Consensual kink appears to fall within the diversity of human sexuality, and knowing that someone is kinky tells us relatively little, by itself, about their psychological health or about what their sexuality means to them.

The rest has to be understood person by person.
...
My work is psychodynamic and attachment-informed, so I am interested in the experiences, relationships and patterns that have shaped how a person understands themselves and relates to others. Sexuality can be part of that picture, and sometimes kink opens up useful conversations about shame, vulnerability, power, intimacy, control or trust.
