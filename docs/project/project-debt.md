...
- `Notes`:
  ...
  - 2026-09-01: Promoted the live `<Button />` contract after a site-wide action audit, moved its shared styles out of the inherited global layer, and migrated the Working with Joel, specialist hero, and Contact invitation decisions onto it. The legacy register now retains only components still outside the active design system.
