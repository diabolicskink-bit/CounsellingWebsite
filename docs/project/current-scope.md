...
- The Codex test bed retains the contact-page direction selected for the public route, while the Opus test bed remains a separate candidate. Shared Fees and Get in touch links open the public Contact page from both test beds. The Dev navigation entry is suppressed on both test beds. Their form compositions are visual interaction references only: they have no submission action, do not call the enquiry endpoint, and do not emit enquiry analytics.
