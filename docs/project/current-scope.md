...
- Home uses a dark, direct opening with routes to the Contact enquiry section and Inclusion hub, followed by a warm editorial welcome, a later portrait-led introduction to Joel on sage, a dark inclusive-practice index, and a focused consultation invitation. The broad introduction covers common and hard-to-name concerns and links to the fuller issues section on Working with Joel; fragment navigation scrolls and moves focus to the destination heading after client-side route changes. On narrow screens, Joel's copy precedes his portrait so the image does not delay the page's substantive introduction.
