...
- Home uses a dark, direct opening with routes to Contact and the Inclusion hub, followed by one warm portrait-led About Vive section. A single uninterrupted narrative introduces Joel, the practice's broad scope and online delivery, his particular commitment and his approach without internal subheadings. The section offers editorial links to Working with Joel and its issues index, but intentionally contains no consultation promotion or conversion CTA; it then leads into the dark inclusive-practice index, while the closing invitation owns the request-a-consult and enquiry action. On narrow screens, Joel's portrait precedes the complete narrative and links.
