...
- The first-party visit endpoint has application-level request and payload controls but no platform rate limit. Its controlled preview flow is complete, but production enablement remains gated by explicit owner approval; platform rate limiting remains unresolved.
