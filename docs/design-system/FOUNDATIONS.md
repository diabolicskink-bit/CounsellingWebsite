...
This catalogue contains the promoted foundation contracts. For permission to use specific inherited identity tokens and global defaults, see the [compatibility baseline](../guidance/DESIGN.md#public-identity-compatibility-baseline). Those items remain outside the promoted system.
...
- `Verified consumers`: `.site-header .header-button`, `.button--primary`, `.site-footer a:focus-visible`, Working with Joel's active-tab rule, article links and focus treatments, Privacy Policy content links, list markers, and focus states, Contact form labels, controls, links, and focus states, and `<ContactInvitation />` editorial emphasis and primary action.
...
- `Verified consumers`: Documents workspace; Home, Working with Joel, Inclusion, Kink and BDSM, ENM and polyamory, LGBTQIA+, and Privacy Policy page backings or editorial sections; and Contact enquiry task.
...
- `Verified consumers`: Supported warm sections; Documents boundaries and Markdown content; Crisis Support service and region separators; Privacy Policy section separators; Contact direct-contact, hours-table frame, crisis-note, and fee separators; `<ContactInvitation />` section, action, and fee separators; and editorial rules across Working with Joel, Inclusion, Kink and BDSM, ENM and polyamory, and LGBTQIA+.
