...
- `Source evidence and public consumers`: Implemented at `src/components/DesignSystemSpecimen.tsx`; reserved for the `/design-system` workspace and excluded from production routes. It currently frames six promoted Foundations specimens and one Patterns specimen.
