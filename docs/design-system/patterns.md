...
- `Verified consumers`: Every current public hero uses the shared frame. Home, Working with Joel, Inclusion, Kink and BDSM, ENM and polyamory, LGBTQIA+, the Articles index, article heroes, and Crisis Support use the applicable opening roles; Contact and Privacy Policy retain their distinct page-owned heading roles. The Documents hero and shared development test-bed hero also consume the applicable roles without becoming production consumers.
...
- `Verified consumers`: Home About Vive and closing invitation; Working with Joel introduction; Inclusion chapters; Contact enquiry task; Privacy Policy document body; Kink misread; ENM reasons; and LGBTQIA+ recognition sections.
