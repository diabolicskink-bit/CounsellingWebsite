...
- `Verified consumers`: Every current public hero uses the shared frame. Home, Working with Joel, Inclusion, Kink and BDSM, ENM and polyamory, LGBTQIA+, the Articles index, article heroes, Crisis Support, and Contact use the applicable opening roles; Privacy Policy retains its distinct page-owned heading role. The Documents hero and shared development test-bed hero also consume the applicable roles without becoming production consumers.
...
- `Verified consumers`: The hero or opening section on Home, Working with Joel, Inclusion, Kink and BDSM, ENM and polyamory, LGBTQIA+, the Articles index and article heroes, Crisis Support, Contact, and Privacy Policy. The Design System cover, Documents hero, and shared development test-bed hero also use the same surface without becoming production consumers.
...
- `Verified consumers`: Home About Vive; Working with Joel introduction; Inclusion chapters; Contact enquiry task; Privacy Policy document body; Kink misread; ENM reasons; and LGBTQIA+ recognition sections.
