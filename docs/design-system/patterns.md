...
- `Verified consumers`: The hero or opening section on Home, Working with Joel, Inclusion, Kink and BDSM, ENM and polyamory, LGBTQIA+, the Articles index and article mastheads, Crisis Support, and Contact. The Design System cover, Documents hero, and shared development test-bed hero also use the same surface without becoming production consumers.
