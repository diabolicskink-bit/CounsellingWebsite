...
- `Pass` Page has one clear page-level heading that matches the page purpose.
  - Note: Checked on `/` in browser at 1280x900. The page has one visible `h1`, "Online Counselling and Therapy Across Australia", matching the Home page purpose while the document title carries the brand name.
